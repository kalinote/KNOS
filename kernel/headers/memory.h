...
extern int ZONE_NORMAL_INDEX;  // low 1GB RAM ,was mapped in pagetable
extern int ZONE_UNMAPED_INDEX; // above 1GB RAM,unmapped in pagetable
...
extern struct Slab_cache kmalloc_cache_size[];
